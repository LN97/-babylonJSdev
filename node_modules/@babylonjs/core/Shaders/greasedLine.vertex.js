...
const shader = `precision highp float;attribute float grl_widths;attribute vec3 grl_offsets;attribute float grl_colorPointers;attribute vec3 position;uniform mat4 worldViewProjection;uniform mat4 projection;varying float grlCounters;varying float grlColorPointer;
...
#endif
void main() {grlColorPointer=grl_colorPointers;
#ifdef GREASED_LINE_CAMERA_FACING
